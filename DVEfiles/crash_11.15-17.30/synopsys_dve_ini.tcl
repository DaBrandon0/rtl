...
# Layout
gui_set_state_value -category Layout -key child_console_size_x -value 1523
gui_set_state_value -category Layout -key child_console_size_y -value 148
...
gui_set_state_value -category Layout -key child_data_size_x -value 347
...
gui_set_state_value -category Layout -key child_hier_size_x -value 143
...
gui_set_state_value -category Layout -key child_source_size_x -value 1036
...
gui_set_state_value -category Layout -key main_pos_y -value 0
gui_set_state_value -category Layout -key main_size_x -value 1523
gui_set_state_value -category Layout -key main_size_y -value 876
...
gui_set_state_value -category Layout -key stand_wave_child_size_y -value 774
gui_set_state_value -category Layout -key stand_wave_top_pos_x -value 0
gui_set_state_value -category Layout -key stand_wave_top_pos_y -value 0
gui_set_state_value -category Layout -key stand_wave_top_size_x -value 1474
gui_set_state_value -category Layout -key stand_wave_top_size_y -value 878
